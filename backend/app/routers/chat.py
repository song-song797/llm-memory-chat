...
from ..schemas import ChatRequest, LandingChatRequest, ModelCatalog, RegenerateRequest
...
async def regenerate_message(
    ...
    """Regenerate an assistant message as a new version."""
    ...
    if assistant_message.parent_message_id is None:
        raise HTTPException(status_code=400, detail="Message has no parent user message")

    # Get the parent user message
    parent_message = db.get(Message, assistant_message.parent_message_id)
